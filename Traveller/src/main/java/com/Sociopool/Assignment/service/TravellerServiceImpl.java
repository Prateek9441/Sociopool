...
public class TravellerServiceImpl implements TravellerService {
	...
	public int getDistance(Traveller_Model entity) {
		...
		List<Traveller> travelList=tr.getTotalDistance(entity.getUserName()
				,entity.getUnix()
				,entity.getEndunix());
		
		return travelList.stream().filter
		(traveller->traveller.getDistance()!=null).
		mapToInt(traveller->Integer.parseInt(traveller.getDistance()))
		.sum();
